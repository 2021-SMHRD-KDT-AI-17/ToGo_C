...
.menu-img-box {
	width: 130px;
	height: 150px;
	background-image: url('resources/images/food/');
	/* 이미지가 아닌 배경 이미지로 설정됨 */
...
<body style="font-family: BMJUA_ttf;">
	...
	<section class="menu-select-area container">
		...
		<div class="wrap">
			<div class="tab_menu">
				<ul class="list" style="padding-right: 10px; padding-top:5px; margin-bottom: 0px;">
					<li class="is_on"><a href="#tab1" class="btn">식사</a>
						<div id="tab1" class="cont" style="overflow-y: scroll;">
							<c:forEach items="${food_menus_list}" var="fm" varStatus="status">
								<div class="flexx" data-bs-toggle="modal"
									data-bs-target="#exampleModal"
									style="display: flex; justify-content: space-around; cursor: pointer;"
									onclick="select_food(${status.count})">
									...
									<div class="menu-img-box">
										<img src="resources/images/food/${fm.menu_img}" alt=""
											height="100px">
									</div>
								</div>
							</c:forEach>
					...
					<!--  ---------------------------------------------------------------------------------------------------------------          ----->
					<li class="is_on"><a href="#tab2" class="btn"
						id="snack_select">간식</a>
						<div id="tab2" class="cont" style="overflow-y: scroll;">

							<c:forEach items="${snack_menus_list}" var="sm"
								varStatus="status">
								<div class="flexx" data-bs-toggle="modal"
									data-bs-target="#exampleModal"
									style="display: flex; justify-content: space-around; cursor: pointer;"
									onclick="select_snack(${status.count})">
									<div class="menu-info-box">
										<p>${sm.menu_name}</p>
										<p>${sm.menu_price}원</p>
										<!-- 좋아요는 결제완료 페이지에서 구현예정 현재는 임시임 -->
					...
					<li class="is_on"><a href="#tab3" class="btn"
						id="beverage_select">음료</a>
						<div id="tab3" class="cont"
							style="overflow-y: scroll; margin-right: 0px;">

							<c:forEach items="${beverage_menus_list}" var="bm"
								varStatus="status">
								<div class="flexx" data-bs-toggle="modal"
									data-bs-target="#exampleModal"
									style="display: flex; justify-content: space-around; cursor: pointer;"
									...
									<div class="menu-img-box">
										<img src="resources/images/food/${bm.menu_img}" alt=""
											height="100px">
									</div>
								</div>
							</c:forEach>
	...
	<section class="container go-cart">
		<div class="go-cart-button">
			...
			<button onclick="location.href ='goBasket'" class="go-basket-b">
				<span><i class="fa-solid fa-cart-shopping"></i>&nbsp;&nbsp;</span>장바구니로
				이동
			</button>
		</div>
	</section>
			...
			<div class="modal-content">
					...
					<div class="menu-modal-box-wrap">
						...
						<div class="menu-detail">
							<article>
								...
								<p class="about-menu" style="margin-bottom: 5px;"
									id="m_menu_desc">여기에 설명 넣으시면 됩니다.</p>
								<p class="menu-price">
									단가:<span id="menuPrice" name="menuPrice_option"></span> 원
								</p>
								<p></p>
							</article>
							...
							<section class="menu-count">
								...
								<div class="menu-count-right">
									...
									<input type='button' class="minus-button"
										onclick='count("minus")' value='-' /> <span id='result'
										name="result_option">1</span> <input type='button'
										class="plus-button" onclick='count("plus")' value='+' />
								</div>
							</section>

							<section>
								<p class="menu-total">
									총 가격 :&nbsp;<span id="total" name="total_option"></span> <span
										class="won">원</span>
								</p>
							</section>
						</div>
				...
				<div class="request">
					<div class="request-text-box" style="height: 30px;">
						<input type="text" id="idx" style="display: none;"> <span
							class="request-text">요청사항</span>
					</div>
					<div style="height: 80px; width: 100%;">
						<textarea style="width: 100%; height: 100%;"
							class="request-text-box" id="requirements"
							name="requirements_option"></textarea>
					</div>
				</div>

				<div class="modal-footer">
					<button type="button" class="close-basket" data-bs-dismiss="modal">닫기</button>

					<button type="submit" class="add-basket" onclick="Add()"
						data-bs-dismiss="modal">
						<i class="fa-solid fa-plus"></i>&nbsp;상품 담기
					</button>
				</div>
			</div>
		</div>
