...
<body>
   ...
   <div class="container">
      <div class="search-box">
         ...
         <div class="search-input">
            <form onsubmit="">
               ...
               <button type="button" class="btn btn-success" onclick="searchAddress()">주소 검색</button>
         ...
         <div class="search-result-box">
            <ul class="search-result-list">
                  ...
                  <li class="search-result-list">
                     <strong>안디옥 휴게소</strong>
                     <p class="result-details">
                        "광주광역시 서구 쌍촌동 번지 1층 888-2"
                        <br>
                        "062-672-1231"
                     </p>
                  </li>
                  <li class="search-result-list">
                     <strong>금곡 휴게소</strong>
                     <p class="result-details">
                        "금곡동 178-1번지 북구 광주광역시"
                        <br>
                        "062-266-3302"
                     </p>
                  </li>
                  <li class="search-result-list">
                     <strong>서울 휴게소</strong>
                     <p class="result-details">
                        "서울시 강동구 명일동 롯데캐슬퍼스트"
                        <br>
                        "02-1111-2222"
      ...
      <section class="map-box">
         ...
         <div><i class="fa-solid fa-street-view my-location"></i></div>
      </section>
